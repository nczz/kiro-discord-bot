...
export function parseJoinFragment(hash = window.location.hash) {
...
export async function deriveSessionKeys(roomID, roomKey) {
...
export async function sealJSON(value, key, roomID, peerID, seq, frameType, direction) {
...
export async function openJSON(payload, key, roomID, expectedPeerID, frameType, direction) {
...
export function writeTokenProof(writeToken) {
...
function associatedData(roomID, direction, peerID, seq, frameType) {
    ...
    return concatBytes(encoder.encode(KEY_INFO), new Uint8Array([0]), encoder.encode(roomID), new Uint8Array([0]), encoder.encode(direction), new Uint8Array([0]), peer, new Uint8Array([0]), sequence, new Uint8Array([0]), new Uint8Array([frameTypeID(frameType)]));
}
function frameTypeID(frameType) {
    return frameType;
}
