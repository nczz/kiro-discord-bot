...
| `bot_send_file` | write, non-destructive | Default-enabled safe file egress. Queue a local text file for bot-side sanitization and upload as a redacted copy to the current channel or thread target; long optional content is split before delivery |
