...
- **Discord MCP scope:** Use `MCP_DISCORD_ALLOWED_GUILDS` and `MCP_DISCORD_ALLOWED_CHANNELS` before exposing tools to broad workspaces. Empty allowlists preserve unrestricted legacy behavior.
