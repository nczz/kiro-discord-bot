...
const pages = [
  ...
  ['Agent Engines', 'guide/agent-engines.html'],
  ['Command Reference', 'guide/commands.html'],
  ['Scoped Skills', 'guide/scoped-skills.html'],
  ['Daily Workflows', 'guide/daily-workflows.html'],
  ['Listen Modes', 'guide/listen-modes.html'],
  ['WebShare', 'guide/webshare.html'],
  ['Operation Matrix', 'guide/operation-matrix.html'],
  ...
  ['Enable A2A with NATS', 'guide/a2a-nats-setup.html'],
  ['A2A Protocol Model', 'guide/a2a-protocol.html'],
...
const zhPages = [
  ...
  ['Agent Engines', 'zh-TW/guide/agent-engines.html'],
  ['指令參考', 'zh-TW/guide/commands.html'],
  ['Scoped Skills', 'zh-TW/guide/scoped-skills.html'],
  ['日常工作流', 'zh-TW/guide/daily-workflows.html'],
  ['監聽模式', 'zh-TW/guide/listen-modes.html'],
  ['WebShare', 'zh-TW/guide/webshare.html'],
  ['操作矩陣', 'zh-TW/guide/operation-matrix.html'],
  ...
  ['使用 NATS 啟用 A2A', 'zh-TW/guide/a2a-nats-setup.html'],
  ['A2A 協議模型', 'zh-TW/guide/a2a-protocol.html'],
